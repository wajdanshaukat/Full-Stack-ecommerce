...
const BottomNav = ({ menuOpen, handleLinkClick }) => {
    ...
    <nav className="bg-white border-b border-gray-200 px-4 lg:px-4 py-2 text-sm md:text-[12px] text-gray-700 mt-2">
          ...
          <div className="relative">
            ...
            {trendingOpen && (
              <div className="absolute right-0 top-full mt-2 bg-white border shadow-lg rounded-md min-w-[180px] z-50">
                <Link to="/top-rated" className="block px-4 py-2 hover:bg-gray-100">Top Rated</Link>
                <Link to="/most-viewed" className="block px-4 py-2 hover:bg-gray-100">Most Viewed</Link>
              </div>
            )}
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 space-y-2 text-sm text-gray-700">
          <Link to="/" className="block" onClick={() => handleLinkClick("Home")}>Home</Link>
          <Link to="/shop" className="block" onClick={() => handleLinkClick("Shop")}>Shop</Link>
          ...
          <Link to="/blog" className="block" onClick={() => handleLinkClick("Blog")}>Blog</Link>
          <Link to="/contact" className="block" onClick={() => handleLinkClick("Contact")}>Contact</Link>
          <Link to="/top-rated" className="block" onClick={() => handleLinkClick("Trending")}>
            Trending Products
          </Link>
        </div>
      )}
